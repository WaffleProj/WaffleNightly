...
#define WAFFLE_PORT_OPTION_INSTRUCTION                      0xBE00  //bkpt 00
#define WAFFLE_PORT_EXCEPTION_INSTRUCTION                   WAFFLE_PORT_DEBUG_INSTRUCTION
#define WAFFLE_PORT_EXCEPTION_INSTRUCTION_DATA              WORD
#define WAFFLE_PORT_OPTION_EXCEPTION_CODE                   EXCEPTION_ILLEGAL_INSTRUCTION
